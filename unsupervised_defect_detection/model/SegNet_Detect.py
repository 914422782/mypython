...
__all__ = ["SegNet_Detect"]

class SegNet_Detect(nn.Module):
    def __init__(self,input= 1, output=1):
        super(SegNet_Detect, self).__init__()
        ...
        self.conv11d = nn.Conv2d(64, output, kernel_size=3, padding=1)
        #self.bn11d = nn.BatchNorm2d(output, momentum=batchNorm_momentum)
...
if __name__ == '__main__':
    ...
    model = SegNet_Detect(classes=19).to(device)
